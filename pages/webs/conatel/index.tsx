  ...
  return (
    <>
      <div className='mx-auto my-0 w-[70%] min-w-[70%] place-content-center lg:w-4/5 md:w-[90%]'>
        ...
        <EmblaCarousel
          props={['/slider-1.jpg', [{ structure: firstSlide() }, { structure: secondSlide() }]]}
        />
        ...
        <div className='mt-10 grid grid-cols-4 bg-[#e5e7f3] p-14 pb-2 text-center font-bold sm:p-2 sm:text-sm'>
          ...
          <div>
            <ul>
              <li className='list-inside list-disc '>Proyectamos</li>
              <li className='list-inside list-disc '>Implantamos</li>
              <li className='list-inside list-disc '>Mantenemos</li>
            </ul>
          ...
          <div>
            <ul>
              <li className='list-inside list-disc '>Industria</li>
              <li className='list-inside list-disc '>Comercio</li>
              <li className='list-inside list-disc '>Servicios</li>
              <li className='list-inside list-disc '>Administración Pública.</li>
            </ul>
          </div>
          <div>
            <p>
              del soporte técnico y los recursos materiales necesarios para facilitar las soluciones
              actuales y de futuro que requieran nuestros clientes.
            </p>{' '}
          </div>
          <div>
            <p>a la vanguardia de las Nuevas Tecnologías emergentes del mercado.</p>{' '}
          </div>
        </div>
      </div>
    </>
