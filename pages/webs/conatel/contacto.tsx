...
import ControlledForm from 'c/UncontrolledForm'
import { ReactElement } from 'react'

export default function Contacto() {
  return (
    <main className='mx-auto my-0 grid w-[70%] min-w-[70%] place-content-center  lg:w-4/5 md:w-[90%]'>
      <h1 className='my-5 min-w-[70vw] text-4xl font-bold'>Contacto</h1>
      <div className='grid place-content-center text-center text-lg font-semibold'>
        ...
        <p>
          En Conatel queremos escuchar tus necesidades y ayudarte con tus proyectos tecnológicos.
        </p>
        <p className='mb-2'>
          Puedes contactar con nosotros a través de cualquiera de los medios que indicamos a
          continuación.
        </p>
        <p className='mb-2 '>
          Si lo deseas puedes contactar con nosotros a través de este formulario
        </p>
      </div>
      <ControlledForm />
      <div className='flex w-auto content-center justify-around rounded-2xl bg-[#e5e7f3] p-8'>
        <div className='m-1 ml-2 flex content-center justify-center'>
          ...
          <div className='ml-2'>
            Estamos en <div>Polígono Plazaola, F</div> <div>nave 1</div>{' '}
            <div>31195 Aizoain – Navarra</div>
          </div>
        </div>
        <div className='flex '>
          <svg
          ...
          <div className='flex-column ml-4 content-center justify-center self-center'>
            ...
            <a href='mailto:conatel@conatel.biz'>conatel@conatel.biz</a>
          </div>
        </div>
        <div className='m-1 ml-2 flex content-center justify-center '>
          <svg
