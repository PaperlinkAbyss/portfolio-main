    ...
    return (
        <>
            <div className='my-0 mx-auto grid w-[70%] min-w-[70%] place-content-center  lg:w-4/5 md:w-[90%]'>
                ...
                <div className='grid text-lg font-semibold text-center place-content-center'>
                ...
                <div className='flex w-auto content-center justify-around rounded-2xl bg-[#e5e7f3] p-8'>
                    <div className='flex content-center justify-center m-1 ml-2'>
                        <svg
                            className='flex self-center justify-center fill-blue-900'
                    ...
                    <div className='flex '>
                        ...
                        <div className='content-center self-center justify-center ml-4 flex-column'>
