    ...
    <div className='grid place-content-center md:max-w-xs'>
      ...
      <div className='content-center bg-white/80 p-2 text-center'>
        <Image
          ...
          className='mx-auto'
        />
        <h2 className='mt-2 font-semibold text-blue-900'>Comunicaciones seguras</h2>
        <p className='my-4 min-w-fit'>
          Con esta solución dispondrás de seguridad en las conexiones entre los dispositivos de tus
  ...
  return (
    <div className='grid place-content-center md:max-w-xs'>
      ...
      <div className='content-center bg-white/80 p-2 text-center'>
        ...
        />
        <div className='p-2 '>
          <h2 className='mt-2 font-semibold text-blue-900'>Ciberseguridad</h2>
          <p className='my-4'>
            El objetivo es proporcionar seguridad básica y avanzada para los dispositivos de tus
            empleados
          </p>
      ...
      <div className='mx-auto my-0  w-[70%] min-w-[70%] place-content-center lg:w-4/5 md:w-[90%]'>
        ...
        <div>
          ...
          <p className='text-center'>
            ...
            medianas empresas, así como autónomos, que tiene como objetivo subvencionar la
            implantación de soluciones digitales para conseguir un avance significativo en el nivel
            de madurez digital. Las subvenciones, de hasta 12.000€, son a fondo perdido y por tanto,
            no suponen ningún gasto para la empresa.
          </p>
          <p className='pb-14 text-center'>
            Este programa contará con una inversión de más de 3.000 millones de euros repartidos de
            2021 a 2023 para impulsar el crecimiento y desarrollo de hasta un millón de pymes y
            autónomos.
          </p>
          <img
          ...
          <div className='mb-14'>
            <div className='grid grid-cols-2 grid-rows-1'>
              ...
              <ol className=' mx-auto list-inside list-[disc] '>
                ...
                <li>
                  Cumplir con los límites financieros y efectivos que definen las diferentes
                  categorías.
                </li>
                <li>
                  Estar en situación de alta y tener la antigüedad mínima establecida en la
                  convocatoria.
                </li>
                <li>Carecer de situación de empresa en crisis.</li>
                <li>
                  Estar al corriente de las obligaciones tributarias frente a la Seguridad Social.
                </li>
                <li>
                  No incurrir en ninguna de las prohibiciones previstas en el artículo 13.2 de la
                  ley 38/2003 de 17 de noviembre general de subvenciones.
                </li>
                <li className='pb-5'>
                  No estar sujeto a ninguna orden de recuperación pendiente por parte de la Comisión
                  Europea que haya declarado ayuda ilegal e incompatible con el mercado común.
                </li>
          ...
          <div className='grid grid-cols-2 '>
            ...
            <div>
              <p className='text-xl text-gray-500'>
                ...
                <a href='acelerapyme.es/kit-digital'>acelerapyme.es</a>. <br></br>Contacta con
                nosotros y te ayudaremos durante todo el proceso.
              </p>
            </div>
          </div>
          <div className='mx-auto grid w-max grid-cols-3 place-content-center gap-2 p-4 md:grid-cols-1'>
            <div className='flex-col content-center justify-center bg-white p-4 text-center '>
              ...
              <h2 className='m-4 text-lg font-bold text-blue-700'>Segmento 1</h2>
              <p className='m-8 text-3xl font-extrabold text-gray-500'>12.000€</p>
              <p className='text-gray-500'>entre 10 y 50 empleados</p>
            </div>
            <div className='flex-col content-center justify-center bg-white p-4 text-center '>
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <h2 className='m-4 text-lg font-bold text-blue-700'>Segmento 2</h2>
              <p className='m-8 text-3xl font-extrabold text-gray-500'>6.000 €</p>
              <p className='text-gray-500'>entre 3 y 9 empleados</p>
            </div>
            <div className='flex-col content-center justify-center bg-white p-4 text-center '>
              <svg
                xmlns='http://www.w3.org/2000/svg'
              ...
              <h2 className='m-4 text-lg font-bold text-blue-700'>Segmento 3</h2>
              <p className='m-8 text-3xl font-extrabold text-gray-500'>2.000 €</p>
