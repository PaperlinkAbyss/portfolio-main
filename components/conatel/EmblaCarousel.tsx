...
export default function EmblaCarousel({ props: [bgImage, structure] }: Elements) {
    ...
    <>
      <div className='bg-lineas mb-4'>
        <div className='embla '>
          ...
          />
          <div
            className='embla__viewport text-xl'
            ref={emblaRef}
          >
            <div className='embla__container'>
              <div className='embla__slide grid place-content-center'>{structure[0].structure}</div>
