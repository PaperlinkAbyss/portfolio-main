  ...
  return (
    <>
      ...
      <div className='mt-5 grid grid-cols-3 grid-rows-2'>
        ...
        <p className='font-semibold'>
          Apostamos por un negocio innovador y de calidad, ya que estamos inmersos en un sector en
          constante evolución.
        </p>
        <p className='font-semibold'>
          Buscamos adaptar las últimas tecnologías a las necesidades de cada cliente.
        </p>
        <p className='font-semibold'>
          La atención y el servicio personalizado para cada cliente es lo que nos motiva y anima a
          seguir esforzándonos en crecer y mejorar como empresa de servicios.
        </p>
        <p className='font-semibold'>
          También atendemos mediante socios tecnológicos y empresas colaboradoras a clientes
          situados en todo el territorio nacional.
        </p>
        <p className='font-semibold'>
      ...
      <div className='mt-5 grid h-max place-content-center bg-[#e5e7f3] bg-main bg-repeat p-7 text-center '>
        ...
        <div className='-mt-20 grid grid-cols-2 grid-rows-2 place-content-center content-center gap-1 text-center '>
          ...
          <div className='mt-28 self-center p-0 pb-5 font-bold'>Seguridad</div>
