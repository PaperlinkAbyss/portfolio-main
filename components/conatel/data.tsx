...
export const secondSlide = () => {
  return (
    <div className='my-center max-w-max bg-white/80 p-4'>
      <h2 className='p-4 text-5xl font-bold'>Kit Digital te ayudamos a conseguirlo</h2>
      <p>
        Una oportunidad única para digitalizar tu negocio con subvenciones a fondo perdido de hasta
        12.000 €
      </p>
    </div>
  )
