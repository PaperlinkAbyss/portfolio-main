...
export type Bulbasaur = typeof bulbasaur
...
export type Sprites = {
    ...
    other: Bulbasaur['sprites']['other']
}
export type Stats = Bulbasaur['stats']
export type Types = Bulbasaur['types']
export type Abilities = Bulbasaur['abilities']
export type ID = Bulbasaur['id']
const bulbasaur = {
    abilities: [
        {
            ability: {
